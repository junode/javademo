<<<<<<< HEAD
package com.spring.cloud.product.collapser;
...
import com.spring.cloud.product.hystrix.cmd.UserFindCommand;

import java.util.Collection;
import java.util.List;

/**** imports ****/
public class UserHystrixCollapser
        extends HystrixCollapser<List<UserInfo>, UserInfo, Long> {
    ...
    public UserHystrixCollapser(UserFacade userFacade, Long id) {
        ...
        super(Setter.withCollapserKey(
                HystrixCollapserKey.Factory.asKey("userGroup"))
                // 请求范围内（作用域）

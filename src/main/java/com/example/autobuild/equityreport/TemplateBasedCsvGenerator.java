 ...
 */
public class TemplateBasedCsvGenerator {
    ...
    public static void main(String[] args) {
        try {
            System.out.println("=== 基于模板的CSV权益日报生成器 ===");
            
            TemplateBasedCsvGenerator generator = new TemplateBasedCsvGenerator();
            generator.generateTemplateBasedCsvReport();
            
            System.out.println("基于模板的CSV权益日报生成完成！");
     ...
     * 生成基于模板的CSV报表
     */
    public void generateTemplateBasedCsvReport() throws IOException {
        // 生成层次结构数据
